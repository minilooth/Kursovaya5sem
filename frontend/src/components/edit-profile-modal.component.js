            ...
            <Modal
              ...
              onHide={this.props.onHide}>
                <Modal.Header closeButton>
                    <Modal.Title><FontAwesomeIcon icon={faEdit}/>&nbsp;Редактирование профиля</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="danger" onClick={this.props.onHide}><FontAwesomeIcon icon={faTimes}/>&nbsp;Отменить</Button>
                </Modal.Footer>
                <ToastContainer/>
            </Modal>
            </>
