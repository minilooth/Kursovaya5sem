...
export default class EditCarModal extends Component {
    ...
    onChangeInteriorMaterial(e) {
        this.setState({
            interiorMaterial: e.target.value
        })
    }
    ...
    validate = () => {
        ...
        if (!String(this.state.mileage).match(/^[0-9]+$/)) {
            this.setState({
        ...
        if (!String(this.state.price).match(/^[0-9]+$/)) {
            this.setState({
            ...
            CarService.get(this.props.initialData.id).then(
                response => {
                    this.setState({
                        ...
                        wheelDriveType: response.data.wheelDriveType,
                        mileage: response.data.mileage,
                        bodyColor: response.data.bodyColor,
                        interiorMaterial: response.data.interiorMaterial,
    ...
    render() {
        ...
        if (!this.state.isLoading) {
            formData = 
                <div>
                    <Form.Row>
                        <Form.Group as={Col} id="brandInput" style={leftFormGroupStyle}>
                            ...
                            {this.state.isBrandInvalid ? <span style={errorStyle}>{this.state.brandError}</span> : null}
                        </Form.Group>
                        <Form.Group as={Col} id="modelInput" style={rightFormGroupStyle}>
                            ...
                            {this.state.isModelInvalid ? <span style={errorStyle}>{this.state.modelError}</span> : null}
                        </Form.Group>
                    </Form.Row>
                    <Form.Row>
                        <Form.Group as={Col} id="yearOfIssueSelect" style={leftFormGroupStyle}>
                            ...
                            {this.state.isYearOfIssueNotSelected ? <span style={errorStyle}>{this.state.yearOfIssueError}</span> : null}
                        </Form.Group>
                        <Form.Group as={Col} id="bodyTypeSelect" style={rightFormGroupStyle}>
                            ...
                            {this.state.isBodyTypeNotSelected ? <span style={errorStyle}>{this.state.bodyTypeError}</span> : null}
                        </Form.Group>
                    </Form.Row>
                    <Form.Row>
                        <Form.Group as={Col} id="engineVolumeSelect" style={leftFormGroupStyle}>
                            ...
                            {this.state.isEngineVolumeNotSelected ? <span style={errorStyle}>{this.state.engineVolumeError}</span> : null}
                        </Form.Group>
                        <Form.Group as={Col} id="engineTypeSelect" style={rightFormGroupStyle}>
                            ...
                            {this.state.isEngineTypeNotSelected ? <span style={errorStyle}>{this.state.engineTypeError}</span> : null}
                        </Form.Group>
                    </Form.Row>
                    <Form.Row>
                        <Form.Group as={Col} id="transmissionTypeSelect" style={leftFormGroupStyle}>
                            ...
                            {this.state.isTransmissionTypeNotSelected ? <span style={errorStyle}>{this.state.transmissionTypeError}</span> : null}
                        </Form.Group>
                        <Form.Group as={Col} id="wheelDriveTypeSelect" style={rightFormGroupStyle}>
                            ...
                            {this.state.isWheelDriveTypeNotSelected ? <span style={errorStyle}>{this.state.wheelDriveTypeError}</span> : null}
                        </Form.Group>
                    </Form.Row>
                    <Form.Row>
                        <Form.Group as={Col} id="mileageInput" style={leftFormGroupStyle}>
                            ...
                            {this.state.isMileageInvalid ? <span style={errorStyle}>{this.state.mileageError}</span> : null}
                        </Form.Group>
                        <Form.Group as={Col} id="bodyColorSelect" style={rightFormGroupStyle}>
                            ...
                            {this.state.isBodyColorNotSelected ? <span style={errorStyle}>{this.state.bodyColorError}</span> : null}
                        </Form.Group>
                    </Form.Row>
                    <Form.Row>
                        <Form.Group as={Col} id="interiorMaterialSelect" style={leftFormGroupStyle}>
                            ...
                            {this.state.isInteriorMaterialNotSelected ? <span style={errorStyle}>{this.state.interiorMaterialError}</span> : null}
                        </Form.Group>
                        <Form.Group as={Col} id="interiorColorSelect" style={rightFormGroupStyle}>
                            ...
                            {this.state.isInteriorColorNotSelected ? <span style={errorStyle}>{this.state.interiorColorError}</span> : null}
                        </Form.Group>
                    </Form.Row>
                        <Form.Group id="priceInput">
                            ...
                            {this.state.isPriceInvalid ? <span style={errorStyle}>{this.state.priceError}</span> : null}
                        </Form.Group>
                    <div style={{display: "flex", flexDirection: "row", width: "100%"}}>
                        ...
                        <div style={{width: "50%", paddingLeft: "20px"}}>
                            {this.state.image === null || this.state.fileBase64 !== ""  ? 
                            
                                this.state.fileBase64 === "" ? (
                                    <div class="add__car__photo-empty">
                ...
                <Modal
                 ...
                 onHide={this.onHide}>
                    <Modal.Header closeButton>
                        <Modal.Title><FontAwesomeIcon icon={faEdit}/>&nbsp;Редактирование автомобиля</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        {formData}
                    </Modal.Body>
                    <Modal.Footer>
                        <Button variant="primary" onClick={this.editCar} disabled={this.state.isDisabled}><FontAwesomeIcon icon={faSave}/>&nbsp;Изменить</Button>
